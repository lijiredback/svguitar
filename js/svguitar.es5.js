    ...
    SVGuitarChord.prototype.drawGrid = function (y) {
        ...
        this.chordInternal.fingers
            ...
            if (fingerOptions.text) {
                _this.renderer.text(fingerOptions.text, nutCenterX, nutCenterY, nutTextSize, fingerOptions.textColor || nutTextColor, fontFamily, Alignment.MIDDLE, true);
            }
        });
        // draw barre chords
        this.chordInternal.barres.forEach(function (_a) {
            ...
            if (text) {
                _this.renderer.text(text, fromStringX + distance / 2, barreCenterY, nutTextSize, textColor || nutTextColor, fontFamily, Alignment.MIDDLE, true);
            }
        });
        return y + height;
    };
